...
/**
 * 关于页: 版本、开发者、下载统计(已下载部数/占用/剩余空间)、操作说明、检查更新按钮。
 * 由片库页头像图标进入; 默认焦点在"检查更新"按钮。
 */
class AboutActivity : ComponentActivity() {

    private lateinit var binding: ActivityAboutBinding
    private val updater = AppUpdater(this, UpdateChecker.CHANNEL_TV)
